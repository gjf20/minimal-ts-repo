...
const tailwindConfigPath = './src/constants/tailwind.config.cjs';
const useTailwind = fs.existsSync(path.join(paths.appPath, tailwindConfigPath));
...
function configFactory(webpackEnv) {
    ...
    return {
        ...
        plugins: [
            ...
            isEnvDevelopment && new BundleAnalyzerPlugin({analyzerHost: '127.0.0.1', analyzerPort: '8888'}),
            ...
            // Remove the development mode of Apollo GQL client - reduces bundle size
            isEnvProduction &&
